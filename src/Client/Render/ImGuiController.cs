...
namespace KronosDMS_Client.Render
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        {
            Logger.Log("Initializing ImGui controller");
            _gd = gd;
            _window = window;
            _windowWidth = width;
        ...
        {
            Logger.Log("Creating ImGui device resources");
        ...
        {
            string logStage = (stage == ShaderStages.Vertex) ? "vertex" : "fragment";
            Logger.Log($"Loading {logStage} shader");
